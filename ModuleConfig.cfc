...
component {
	...
	// Module Properties
	this.title              = "commandbox-npm";
	this.author             = "Dan Card";
	this.webURL             = "";
	this.description        = "Tools to administer local packages";
	this.version            = "1.0.0";
	...
	// Module Entry Point
	this.entryPoint         = "commandbox-npm";
	// Inherit Entry Point
	this.inheritEntryPoint  = false;
	// Model Namespace
	this.modelNamespace     = "commandbox-npm";
	// CF Mapping
	this.cfmapping          = "commandbox-npm";
	// Auto-map models
